...
Feature 2: Link to 1.3.4 to generate report on Fundability Score.
        ...
        <ComingSoon module="1.2.1 Fundability Score" title="Your Fundability Score" description="A dynamic percentage score (0‑100%) summarising your overall investor‑readiness. The North Star metric." />
      </div>
    </div>
  );
}
