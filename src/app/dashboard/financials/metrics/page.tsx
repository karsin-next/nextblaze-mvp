...
Feature 2: Interactive sliders for each of the three metrics. The runway and dashboard update in real time.
        ...
        <ComingSoon module="2.1.1 Key Metrics Entry" title="Scenario-Based Financial Simulator" description="Enter your 3 key revenue metrics -- monthly revenue, monthly burn, and current cash balance. This gives instant runway and burn visuals without sensitive data. Explore “what if” scenarios by adjusting revenue, burn, or cash assumptions." />
      </div>
    </div>
  );
}
