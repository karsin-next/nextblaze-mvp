    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { name: "1.2.3 Benchmark Comparison", soon: true, href: "/dashboard/score/benchmark", icon: BarChart3 },
          { name: "1.2.4 Score History", soon: true, href: "/dashboard/score/history", icon: LineChart },
        ],
      },
      {
        ...
        icon: BarChart3,
        children: [
          { name: "1.3.1 Top 3 Gaps", soon: true, href: "/dashboard/gap-report/top-3", icon: AlertTriangle },
          { name: "1.3.2 Gap Deep Dive", soon: true, href: "/dashboard/gap-report/deep-dive", icon: Search },
          { name: "1.3.3 Recommended Actions", soon: true, href: "/dashboard/gap-report/actions", icon: CheckSquare },
          { name: "1.3.4 Investor-Ready Report", soon: true, href: "/dashboard/gap-report/report", icon: FileText },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        icon: Calculator,
        children: [
          { name: "2.1.1 Key Metrics Entry", soon: true, href: "/dashboard/financials/metrics", icon: Edit },
          { name: "2.1.2 EBDAT Breakeven", soon: true, href: "/dashboard/financials/breakeven", icon: Tally3 },
          { name: "2.1.3 Cash Flow Snapshot", soon: true, href: "/dashboard/financials/cash-flow", icon: Wallet },
        ],
      },
      {
        ...
        children: [
          { name: "2.2.1 Runway & Burn", soon: true, href: "/dashboard/metrics/runway", icon: Flame },
          { name: "2.2.2 Revenue & Growth", soon: true, href: "/dashboard/metrics/revenue", icon: TrendingUp },
          { name: "2.2.3 Expense Breakdown", soon: true, href: "/dashboard/metrics/expenses", icon: PieChart },
          { name: "2.2.4 Custom Views", soon: true, href: "/dashboard/metrics/views", icon: Eye },
        ],
      },
      {
        ...
        icon: LineChart,
        children: [
          { name: "2.3.1 CAC Calculator", soon: true, href: "/dashboard/unit-economics/cac", icon: Users },
          { name: "2.3.2 LTV Estimator", soon: true, href: "/dashboard/unit-economics/ltv", icon: Infinity },
          { name: "2.3.3 Gross Margin", soon: true, href: "/dashboard/unit-economics/margin", icon: Percent },
          { name: "2.3.4 Cash Conversion Cycle", soon: true, href: "/dashboard/unit-economics/ccc", icon: RefreshCw },
        ],
      },
      {
        ...
        icon: Map,
        children: [
          { name: "2.4.1 WHAT: Capital Needs", soon: true, href: "/dashboard/strategy/what", icon: DollarSign },
          { name: "2.4.2 WHY: Use of Funds", soon: true, href: "/dashboard/strategy/why", icon: PieChart },
          { name: "2.4.3 WHEN: Timing & Runway", soon: true, href: "/dashboard/strategy/when", icon: Clock },
          { name: "2.4.4 HOW: Cash Flow Projection", soon: true, href: "/dashboard/strategy/how", icon: LineChart },
          { name: "2.4.5 WHO: Investor Matching", soon: true, href: "/dashboard/strategy/who", icon: Users },
        ],
      },
      {
        ...
        icon: FolderOpen,
        children: [
          { name: "2.5.1 Structure Template", soon: true, href: "/dashboard/data-room/structure", icon: Folders },
          { name: "2.5.2 Document Checklist", soon: true, href: "/dashboard/data-room/checklist", icon: ListChecks },
          { name: "2.5.3 Investor Access Simulator", soon: true, href: "/dashboard/data-room/simulator", icon: Lock },
          { name: "2.5.4 Readiness Score", soon: true, href: "/dashboard/data-room/score", icon: ShieldCheck },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        icon: Activity,
        children: [
          { name: "3.1.1 Personalised Action Plan", soon: true, href: "/dashboard/workbench/plan", icon: CheckSquare },
          { name: "3.1.2 Tool Library", soon: true, href: "/dashboard/workbench/tools", icon: Wrench },
          { name: "3.1.3 AI Coach Assistant", soon: true, href: "/dashboard/workbench/coach", icon: Bot },
        ],
      },
      {
        ...
        icon: Target,
        children: [
          { name: "3.2.1 Investor Profile Builder", soon: true, href: "/dashboard/investors/profile", icon: UserPlus },
          { name: "3.2.2 Portfolio & Competitor Check", soon: true, href: "/dashboard/investors/portfolio", icon: Search },
        ],
      },
      {
        ...
        icon: Eye,
        children: [
          { name: "3.2.3 Profile Visibility", soon: true, href: "/dashboard/visibility/toggle", icon: Eye },
          { name: "3.2.4 FundabilityOS Verified Badge", soon: true, href: "/dashboard/visibility/badge", icon: ShieldCheck },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        icon: FileSearch,
        children: [
          { name: "4.1.1 Term Sheet Anatomy", soon: true, href: "/dashboard/term-sheet/anatomy", icon: FileText },
          { name: "4.1.2 Valuation Simulator", soon: true, href: "/dashboard/term-sheet/valuation", icon: Calculator },
          { name: "4.1.3 Liquidation Preference Simulator", soon: true, href: "/dashboard/term-sheet/liquidation", icon: ArrowDownToLine },
          { name: "4.1.4 Anti‑Dilution Comparison", soon: true, href: "/dashboard/term-sheet/anti-dilution", icon: ShieldAlert },
        ],
      },
      {
        ...
        icon: Search,
        children: [
          { name: "4.2.1 Legal DD Checklist", soon: true, href: "/dashboard/dd-simulator/legal", icon: Briefcase },
          { name: "4.2.2 Financial DD Prep", soon: true, href: "/dashboard/dd-simulator/financial", icon: PieChart },
          { name: "4.2.3 IP Audit Tool", soon: true, href: "/dashboard/dd-simulator/ip", icon: Copyleft },
          { name: "4.2.4 Mock Q & A", soon: true, href: "/dashboard/dd-simulator/qa", icon: MessageSquare },
        ],
      },
    ],
  },
